const translations = {
  zh: {
    ...
    featureInviteTitle: '好友私聊、语音通话与会议邀请', featureInviteText: '好友可直接进行一对一中俄翻译聊天或实时翻译语音通话，无需创建会议房间；需要多人参与和 AI 纪要时，再创建会议并邀请成员。',
    featureRecordTitle: '记录、导出与 AI 会议纪要', featureRecordText: '按时间或发言者查看完整内容，导出 TXT、Markdown；会议结束后由 AI 整理主要内容，经主持人确认再分发。',
    friendCallNav: '好友通话', friendCallEyebrow: '好友之间，直接通话', friendCallTitle: '和好友直接通话，\n中文俄语边说边译。', friendCallLead: '无需创建会议。像打电话一样呼叫好友，接通后保留原声通话，同时显示中俄字幕并播放译音频。',
    friendCallPoint1Title: '电话式呼叫', friendCallPoint1Text: '等待音、铃声、接听、拒绝、静音与扬声器。', friendCallPoint2Title: '边通话，边翻译', friendCallPoint2Text: '原文、译文和译音频随通话同步呈现。', friendCallPoint3Title: '后台也能提醒', friendCallPoint3Text: '退到后台或锁屏时显示高优先级来电通知。', friendCallBoundary: '好友通话专注即时沟通，不生成会议纪要；需要 AI 整理与分发时，请创建正式会议。', friendCallScreenshotLabel: '实际通话界面 · 中俄字幕与译音频同步', friendCallVisualCall: '来电铃声与后台提醒', friendCallVisualTranslate: '原声通话与实时翻译并行', friendCallScreenshotAlt: 'RUSCNY 好友实时翻译语音通话界面',
    ...
    legalBack: '返回官网', legalLanguage: '界面语言', privacyTitle: '隐私政策', termsTitle: '用户协议', legalDraft: '发布候选文本', legalNotice: '正式运营主体、联系方式、数据存储地域和具体保留期限将在上线前补齐，并经法律审核后生效。', updated: '更新日期：2026年7月20日',
    privacyIntroTitle: '我们如何处理信息', privacyIntro: '本应用帮助中文和俄语使用者进行好友一对一翻译聊天和多人语音翻译会议。我们只处理提供认证、好友关系、翻译、同步、记录和安全保障所必要的信息。',
    privacyCollectTitle: '我们处理的信息', privacyCollect: '包括账号与身份资料、好友关系、私聊或参会者的姓名/公司/语言、接收会议纪要的邮箱、会议关系、最终原文和译文、发言者快照、消息顺序与状态，以及提供服务所需的设备和安全日志。临时用户资料仅用于其获邀会议。',
    privacyAudioTitle: '语音与翻译', privacyAudio: '只有在用户主动按住说话时才提交语音片段。当前版本默认不长期保存完整原始录音或临时识别结果；最终译文语音可保存在私有对象存储并通过短期授权播放。',
    privacyPurposeTitle: '使用目的', privacyPurpose: '用于登录和设备安全、好友一对一聊天、创建与加入会议、中俄识别和翻译、译文语音、实时同步、历史、会议导出、主持人明确选择后的纪要邮件分发、断线补拉、幂等去重、安全审计和处理用户请求。私聊不用于导出、AI 整理或纪要分发；纪要逐人发送，不公开其他参会者邮箱。我们不将聊天或会议内容用于广告。',
    ...
    privacySecurityTitle: '安全与隔离', privacySecurity: '权限以服务端认证主体、好友关系和会议关系为准。私聊与每次会议均按 conversationId 隔离；好友关系解除后不能发送新私聊，被移出、会议结束、设备撤销或历史授权到期后，访问权限立即重新校验。',
    ...
    termsServiceTitle: '服务内容', termsService: '服务包括中俄按住说话翻译、好友一对一私聊、多人会议、注册与临时参会、好友邀请、发言者归属、译文语音、历史、会议导出和结构化会议纪要。好友私聊只保留消息记录，不支持导出、AI 整理或纪要分发。服务不承诺连续同声传译、重叠发言自动分离或翻译绝对准确。',
  ...
  ru: {
    ...
    featureInviteTitle: 'Личный чат, звонки и приглашения', featureInviteText: 'Друзья могут общаться в личном чате или начать голосовой звонок с переводом без комнаты встречи. Для группы и AI-протокола создайте встречу и пригласите участников.',
    ...
    friendCallNav: 'Звонок другу', friendCallEyebrow: 'Прямой звонок другу', friendCallTitle: 'Звонок другу —\nс переводом в реальном времени.', friendCallLead: 'Комната встречи не нужна. Позвоните другу как обычно: после ответа сохраняется исходный звук, а китайские и русские субтитры и озвученный перевод появляются во время разговора.',
    friendCallPoint1Title: 'Обычный звонок', friendCallPoint1Text: 'Гудок, мелодия, ответ, отклонение, микрофон и динамик.', friendCallPoint2Title: 'Разговор с переводом', friendCallPoint2Text: 'Оригинал, перевод и озвучивание появляются синхронно.', friendCallPoint3Title: 'Уведомление в фоне', friendCallPoint3Text: 'При свёрнутом приложении и на заблокированном экране.', friendCallBoundary: 'Личный звонок предназначен для общения и не создаёт протокол. Для AI-обработки и отправки итогов создайте встречу.', friendCallScreenshotLabel: 'Реальный экран звонка · субтитры и озвучивание', friendCallVisualCall: 'Мелодия и фоновое уведомление', friendCallVisualTranslate: 'Исходный звук и перевод одновременно', friendCallScreenshotAlt: 'Экран звонка RUSCNY с переводом в реальном времени',
    ...
    legalBack: 'На главную', legalLanguage: 'Язык интерфейса', privacyTitle: 'Политика конфиденциальности', termsTitle: 'Условия использования', legalDraft: 'Текст-кандидат к публикации', legalNotice: 'Юридическое лицо оператора, контакты, регион хранения и точные сроки будут добавлены и юридически проверены до запуска.', updated: 'Обновлено: 20 июля 2026 г.',
    privacyIntroTitle: 'Как мы обрабатываем данные', privacyIntro: 'Приложение помогает русско- и китайскоязычным пользователям общаться в личных чатах друзей и проводить групповые встречи с голосовым переводом. Мы обрабатываем только данные, необходимые для аутентификации, дружеских связей, перевода, синхронизации, истории и безопасности.',
    privacyCollectTitle: 'Какие данные обрабатываются', privacyCollect: 'Данные аккаунта и профиля, дружеские связи, имя/компания/язык собеседника или участника, email для получения протокола, связи со встречей, финальный оригинал и перевод, снимок автора, порядок и статус сообщений, а также технические журналы безопасности. Данные гостя относятся только к приглашённой встрече.',
    ...
    privacyPurposeTitle: 'Цели обработки', privacyPurpose: 'Вход и безопасность устройства, личные чаты друзей, встречи, распознавание и перевод, озвучивание, синхронизация, история, экспорт встреч, отправка протокола по явному выбору организатора, восстановление после обрыва, дедупликация, аудит и запросы пользователей. Личный чат не используется для экспорта, ИИ-обработки или рассылки протокола. Письма отправляются отдельно, адреса других участников не раскрываются. Содержание чатов и встреч не используется для рекламы.',
    ...
    privacySecurityTitle: 'Безопасность и изоляция', privacySecurity: 'Доступ определяется серверной личностью, дружескими связями и отношениями со встречей. Личный чат и каждая встреча изолированы по conversationId. После удаления из друзей нельзя отправлять новые сообщения; после удаления участника, завершения встречи, отзыва устройства или окончания срока права проверяются заново.',
    ...
    termsServiceTitle: 'Содержание сервиса', termsService: 'Сервис включает перевод по нажатию, личные чаты друзей, групповые встречи, аккаунты и гостей, приглашения, авторство реплик, озвучивание, историю, экспорт встреч и структурированный протокол. В личном чате сохраняются только сообщения: экспорт, ИИ-обработка и рассылка протокола недоступны. Не гарантируются непрерывный синхронный перевод, автоматическое разделение одновременной речи или абсолютная точность.',
...
function applyLocale(locale) {
  ...
  const friendCallScreen = document.querySelector('.friend-call-screen');
  if (friendCallScreen) {
    const source = selected === 'ru' ? friendCallScreen.dataset.srcRu : friendCallScreen.dataset.srcZh;
    if (source) friendCallScreen.setAttribute('src', source);
    if (dictionary.friendCallScreenshotAlt) friendCallScreen.setAttribute('alt', dictionary.friendCallScreenshotAlt);
  }
