const translations = {
  zh: {
    ...
    demoTitle: '项目沟通会', live: '实时', participants: '参会者 · 5', companyZh: '采购部 · 中文', companyZh2: '技术部 · 中文', speakingNow: '王伟正在发言', demoZh: '这批设备计划下周发往莫斯科。', demoCn: '请确认装箱单。', holdTalk: '按住说话', releaseSend: '松开后提交翻译', floatingIdentity: '每段内容\n保留发言归属', floatingReconnect: '断线重连\n自动补齐消息',
    ...
    meetingEyebrow: '一个房间，多方参与', meetingTitle: '中方四人、俄方一人，\n也能像面对面一样有序。', meetingLead: '每位参会者拥有独立身份和语言。主持人随时查看在线状态、邀请好友或移出人员；会议结束后立即转为只读。',
    ...
    accountBenefit1Title: '创建或加入会议', accountBenefit1Text: '所有注册用户均可发起会议，也可以接受邀请加入会议。', accountBenefit2Title: '身份跟随每段发言', accountBenefit2Text: '显示名称、公司和语言与实际账号关联。', accountBenefit3Title: '中俄双语使用', accountBenefit3Text: '网页默认跟随系统语言，也可随时切换。', accountBoundary: '网页用于注册和登录验证；语音会议、好友与历史记录的完整功能仍在手机 App 中使用。',
    authRegisterTab: '注册', authLoginTab: '登录', registrationTitle: '创建正式账号', registrationText: '填写资料后，账号会立即建立并登录当前网页。', loginTitle: '欢迎回来', loginText: '使用与手机 App 相同的账号登录。', displayNameLabel: '姓名或显示名称 *', companyLabel: '所属公司（选填）', languagePreference: '主要使用语言 *', emailLabel: '邮箱 *', passwordLabel: '密码 *', passwordHelp: '至少 8 位，最多 128 位。', confirmPasswordLabel: '再次输入密码 *', consentBefore: '我已阅读并同意', consentAnd: '和', submitRegister: '注册并登录', submitLogin: '登录', haveAccount: '已经有账号？', signInNow: '直接登录', noAccount: '还没有账号？', createNow: '立即注册',
    sessionTitle: '账号已就绪', sessionLead: '当前网页已登录。请在手机 App 中使用同一账号进入完整工作区。', profileName: '显示名称', profileEmail: '邮箱', profileCompany: '公司', profileLanguage: '语言', logout: '退出当前网页账号',
  ...
  ru: {
    ...
    featureRecordTitle: 'История, экспорт и протокол', featureRecordText: 'Просмотр по времени или участнику, экспорт TXT и Markdown, протокол с позициями сторон и ответственными.',
    meetingEyebrow: 'Одна комната, несколько сторон', meetingTitle: 'Четыре участника из Китая и один из России —\nвсё равно по порядку.', meetingLead: 'У каждого свой профиль и язык. Организатор видит статусы, приглашает друзей или удаляет участника. После завершения встреча сразу становится доступной только для чтения.',
    ...
    accountBenefit1Title: 'Создавайте встречи или участвуйте', accountBenefit1Text: 'Любой зарегистрированный пользователь может создать встречу или присоединиться по приглашению.', accountBenefit2Title: 'Личность у каждой реплики', accountBenefit2Text: 'Имя, компания и язык связаны с реальным аккаунтом.', accountBenefit3Title: 'Интерфейс на двух языках', accountBenefit3Text: 'Язык следует системе, но его всегда можно изменить.', accountBoundary: 'На сайте доступны регистрация и проверка входа. Голосовые встречи, друзья и полная история работают в мобильном приложении.',
    authRegisterTab: 'Регистрация', authLoginTab: 'Вход', registrationTitle: 'Создать аккаунт', registrationText: 'Заполните профиль — аккаунт будет создан и выполнится вход на сайте.', loginTitle: 'С возвращением', loginText: 'Используйте тот же аккаунт, что и в мобильном приложении.', displayNameLabel: 'Имя или отображаемое имя *', companyLabel: 'Компания (необязательно)', languagePreference: 'Основной язык *', emailLabel: 'Email *', passwordLabel: 'Пароль *', passwordHelp: 'От 8 до 128 символов.', confirmPasswordLabel: 'Повторите пароль *', consentBefore: 'Я прочитал(а) и принимаю', consentAnd: 'и', submitRegister: 'Зарегистрироваться и войти', submitLogin: 'Войти', haveAccount: 'Уже есть аккаунт?', signInNow: 'Войти', noAccount: 'Нет аккаунта?', createNow: 'Зарегистрироваться',
    sessionTitle: 'Аккаунт готов', sessionLead: 'На этом сайте выполнен вход. Используйте тот же аккаунт в мобильном приложении для полного рабочего пространства.', profileName: 'Отображаемое имя', profileEmail: 'Email', profileCompany: 'Компания', profileLanguage: 'Язык', logout: 'Выйти на этом сайте',
