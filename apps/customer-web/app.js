const translations = {
  zh: {
    ...
    friendCallNav: '好友通话', friendCallEyebrow: '好友之间，直接通话', friendCallTitle: '不必创建会议，\n直接拨打实时翻译语音通话。', friendCallLead: '选择好友即可呼叫。来电时播放铃声，并通过系统来电通知提醒；接通后，双方继续听到通话原声，同时查看中俄实时字幕并播放译音频。',
    friendCallPoint1Title: '像电话一样呼叫与接听', friendCallPoint1Text: '有等待音、来电铃声、接听、拒绝、静音和扬声器控制。', friendCallPoint2Title: '通话中实时双向翻译', friendCallPoint2Text: '🇨🇳 中文与 🇷🇺 Русский 的原文、译文和译音频同步呈现。', friendCallPoint3Title: '后台仍有系统提醒', friendCallPoint3Text: '应用退到后台或锁屏时，通过高优先级来电通知提醒接听。', friendCallBoundary: '好友通话不生成会议纪要；需要整理、确认和分发时，请创建正式会议。', friendCallDemoLabel: '好友实时翻译通话', friendCallConnected: '已接通', friendCallDuration: '通话中 · 00:48', friendCallTranslationText: '请确认交货时间。', friendCallRingtone: '系统来电铃声',
  ...
  ru: {
    ...
    friendCallNav: 'Звонок другу', friendCallEyebrow: 'Прямой звонок другу', friendCallTitle: 'Без комнаты встречи.\nПозвоните с переводом в реальном времени.', friendCallLead: 'Выберите друга и позвоните ему. Входящий звонок сопровождается мелодией и системным уведомлением. После ответа участники слышат исходную речь, видят китайские и русские субтитры и получают озвученный перевод.',
    friendCallPoint1Title: 'Звонок и ответ как по телефону', friendCallPoint1Text: 'Гудок ожидания, мелодия входящего вызова, ответ, отклонение, микрофон и динамик.', friendCallPoint2Title: 'Двусторонний перевод во время звонка', friendCallPoint2Text: 'Оригинал, перевод и озвучивание 🇨🇳 中文 ⇄ 🇷🇺 Русский синхронизируются в реальном времени.', friendCallPoint3Title: 'Системное уведомление в фоне', friendCallPoint3Text: 'Когда приложение свёрнуто или экран заблокирован, о звонке сообщает приоритетное системное уведомление.', friendCallBoundary: 'Личный звонок не создаёт протокол. Для подготовки, подтверждения и отправки итогов создайте встречу.', friendCallDemoLabel: 'Звонок другу с переводом', friendCallConnected: 'Подключено', friendCallDuration: 'Разговор · 00:48', friendCallTranslationText: 'Пожалуйста, подтвердите время доставки.', friendCallRingtone: 'Системная мелодия вызова',
